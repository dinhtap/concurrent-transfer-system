...
public class CycleTests {
    ...
    private static cp2023.base.StorageSystem setupSystem() {
        ...
        initialComponentMapping.put(comp5, dev3);
    ...
    private final static Collection<Thread> setupTransferers(StorageSystem system) {
        ...
        transferer.add(new Thread(new Runnable() {
            ...
            public void run() {
                System.out.println("Transferer " + Thread.currentThread().getId() + " has started.");
                executeTransfer(system, 103, 2, 3, 10);
        ...
        transferer.add(new Thread(new Runnable() {
            ...
            public void run() {
                sleep(30);
                System.out.println("Transferer " + Thread.currentThread().getId() + " has started.");
                executeTransfer(system, 105, 3, 1, 10);
                executeTransfer(system, 104, 2, 0, 10);
                System.out.println("Transferer " + Thread.currentThread().getId() + " has finished.");
            }
        }));
        return transferer;
    ...
    private final static CycleTests.CompTransfImpl executeTransfer(
        ...
        CycleTests.CompTransfImpl transfer =
                new CycleTests.CompTransfImpl(
